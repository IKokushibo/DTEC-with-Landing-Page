    ...
    <>
      ...
      <div className="min-h-screen bg-gray-100">
        ...
        <div className="flex justify-center space-x-8 mt-10">
          <button onClick={() => navigate('/moderator/transaction')} className="text-2xl w-80 bg-green-700 hover:bg-green-800 text-white font-bold py-6 px-10 rounded-lg flex items-center flex-col">
            <img src={DT} alt="Transactions" className="ml-4 w-6 h-6 mb-4" />
            Transactions
          </button>
          <button onClick={() => navigate('/moderator/e-clearance')} className="text-2xl flex-col w-80 bg-yellow-500 hover:bg-yellow-600 text-black font-bold py-6 px-10 rounded-lg flex items-center">
